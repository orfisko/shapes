...
def test_orientation(polyhedron_cutout_sloped):
    ...
    assert poly.faces[0].orientation == FaceNormal.T
    assert poly.faces[1].orientation == FaceNormal.R_T
    assert poly.faces[2].orientation == FaceNormal.R
    assert poly.faces[3].orientation == FaceNormal.B
    assert poly.faces[4].orientation == FaceNormal.L
